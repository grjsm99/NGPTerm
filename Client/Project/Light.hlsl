...
float4 CalculateLight(float4 color, float3 _Position, float3 _Normal) {
    ...
    //if (color.r < 0.2f)
    //    color.r = 0.0f;
    //else if (color.r < 0.4f) 
    //    color.r = 0.2f;
    //else if (color.r < 0.6f) 
    //    color.r = 0.4f;
    //else if (color.r < 0.8f) 
    //    color.r = 0.6f;
    ...
    //if (color.g < 0.2f)
    //    color.g = 0.0f;
    //else if (color.g < 0.4f) 
    //    color.g = 0.2f;
    //else if (color.g < 0.6f) 
    //    color.g = 0.4f;
    ...
    //if (color.b < 0.2f)
    //    color.b = 0.0f;
    //else if (color.b < 0.4f) 
    //    color.b = 0.2f;
    //else if (color.b < 0.6f) 
    //    color.b = 0.4f;
